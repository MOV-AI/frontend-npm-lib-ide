...
import { call, subscribe, useRemix } from "./../../../../utils/noremix";
...
const BaseFlow = props => {
  ...
  useEffect(() => subscribe(PLUGINS.FLOW_EXPLORER.NAME, PLUGINS.FLOW_EXPLORER.ON.ADD_NODE, node => {
